...
1. Nasaďte webovou aplikace do Azure App Service:
	...
	1. Doklikáním wizardu do konce dojde k založení Resource Group, Azure App Service Planu i samotné Azure App Service. Profil pro nasazení (publikování) aplikace do Azure je připraven:
...
1. [OPTIONAL] Prozkoumejte možnost nasazování přes *GitHub Actions*, které se vám nabízely v posledním kroku wizardu.