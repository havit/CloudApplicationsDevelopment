...
namespace MyWebApplication.Pages
{
	public class IndexModel : PageModel
	{
		...
		private const string AzureStorageUrl = "https://<your-storage-account-name>.blob.core.windows.net/<your-container-name>";
		...
		{
			return new Azure.Storage.Blobs.BlobContainerClient(new Uri(AzureStorageUrl), new DefaultAzureCredential());
		}
	}
}